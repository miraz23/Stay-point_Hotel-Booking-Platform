...
import { MapPinIcon, CurrencyDollarIcon, StarIcon } from '@heroicons/react/24/solid';
                    ...
                    hotels.map((hotel) => (
                        <div className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.33%-12px)] flex flex-col border-2 border-[#fff] rounded-xl p-4 bg-white shadow-2xl" key={hotel.id}>
                                <div className="flex flex-col justify-center items-center mb-4">
                                    <div className="aspect-[3/2] bg-gray-200 flex items-center justify-center rounded-xl">
                                        <img className="w-full h-full object-cover rounded-xl" src={hotel.image} alt="Hotel Logo" />
                                    </div>
